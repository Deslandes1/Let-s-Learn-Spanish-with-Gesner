...
# ----- Improved safe import for edge_tts with detailed error -----
...
try:
    ...
    st.error(f"❌ Audio import error: {type(e).__name__}: {e}")
    st.warning("""
    **Audio is disabled**.  
    Please make sure your `requirements.txt` contains:Then redeploy your app.
""")
# ----------------------------------------------------------------
...
if not EDGE_TTS_AVAILABLE:
    st.info("🔇 Audio no disponible – por favor instala edge-tts y nest-asyncio.")
    return
